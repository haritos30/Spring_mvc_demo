...
import com.test.mvctest.service.PersonService;
...
public class MainController {
	 ...
	 * This is also the home page of the application (as defined in the servlet context)
	 * 
	...
	public String delete(@RequestParam(value = "id", required = true) Integer id, Model model) {
		...
		logger.info("Received request to delete existing person");
